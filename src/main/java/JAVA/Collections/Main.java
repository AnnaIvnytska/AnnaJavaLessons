...
//        System.out.println(Arrays.toString(collectionImplement.toArray()));                                                       // работает(проверка для addAll)
//        collectionImplement.clear();                                                                                              // работает
//        System.out.println("collectionImplement.containsAll() = " + collectionImplement.containsAll(additionalCollection));       // работает
...
//        System.out.println("collectionImplement.retainAll() = " + collectionImplement.retainAll(additionalCollection));            // работает
//        System.out.println("collectionImplement.add() = " + collectionImplement.add(aaa));                                         // работает
//        System.out.println(Arrays.toString(collectionImplement.toArray()));                                                        // работает(проверка для add)
